  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <button
        ...
        className="group block w-full text-left border-l border-border pl-4 py-4 transition-all duration-150 hover:border-primary"
      >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {experience.highlights.map((highlight, index) => (
              <div
                key={index}
                className="border-l border-border pl-4 py-2"
              >
